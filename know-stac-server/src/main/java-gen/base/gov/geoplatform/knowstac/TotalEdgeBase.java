...
@com.runwaysdk.business.ClassSignature(hash = -1074207024)
/**
 ...
 */
public abstract class TotalEdgeBase extends com.runwaysdk.business.Business
{
  ...
  private static final long serialVersionUID = -1074207024;
  
  public TotalEdgeBase()
  {
    super();
  }
  ...
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(gov.geoplatform.knowstac.TotalEdge.CLASS);
  ...
  public static TotalEdgeQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    TotalEdgeQuery query = new TotalEdgeQuery(new com.runwaysdk.query.QueryFactory());
    com.runwaysdk.business.Entity.getAllInstances(query, sortAttribute, ascending, pageSize, pageNumber);
    return query;
  }
  
  public static TotalEdge get(String oid)
  {
    return (TotalEdge) com.runwaysdk.business.Business.get(oid);
  }
  
  public static TotalEdge getByKey(String key)
  {
    return (TotalEdge) com.runwaysdk.business.Business.get(CLASS, key);
  }
  
  public static TotalEdge lock(java.lang.String oid)
  {
    TotalEdge _instance = TotalEdge.get(oid);
    _instance.lock();
    
    return _instance;
  }
  
  public static TotalEdge unlock(java.lang.String oid)
  {
    TotalEdge _instance = TotalEdge.get(oid);
    _instance.unlock();
